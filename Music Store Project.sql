...
/* Q10: We want to find out the most popular music genre for each country. We determine the most popular
		...
		top genre. For countries where the maximum number of purchases is shared return all the genres.*/
...
/* Q11: Write a query that determines the customer that has spent the most on music for each country. 
		...
		countries where the top amount is shared, provide all customers who spent this amount.*/
